...
Make sure trailing whitespace is expelled from strong/emphasis marks when they are broken up by other marks.

## 1.13.6 (2026-08-16)

### Bug fixes

Fix an issue where `MarkdownSerializer` could emit invalid strong/emphasis marks when the mark was broken up by another mark right before whitespace.

## 1.13.5 (2026-07-06)

### Bug fixes

Don't drop an `order` attribute of 0 for numbered lists when serializing.
